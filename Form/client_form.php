	...
	<div class="container card" style="width: 50%;">
		<div class="row" style="margin:2px 2px 2px 2px">
			<div class="col">
				...
				<div class="row">
					<select  class="form-control" style="width: 70%; border-width: 1.5px; border-radius: 6px; margin: 2px 2px; padding: 1px 1px;" required>
			...
			<div class="col">
				...
				<div class="row">
					<select class="form-control" style="width: 70%; border-width: 1.5px; border-radius: 6px; margin: 2px 2px; padding: 2px 2px;" required>
