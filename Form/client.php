	...
	if (isset($_POST['submit']))
	 {
			...
			$query = "INSERT INTO `reg_client`(`fname`, `lname`, `fathername`, `mothername`, `dob`, `mobile`, `email`, `address`, `state`, `district`, `passwd`, `hash`) VALUES ('".$fname."', '".$lname."', '".$fathername."', '".$mothername."', '".$dob."', '".$mobile."', '".$email."', '".$residence."', '".$state."', '".$district."', '".$passwd."', '".$activate."') ";
			echo $query;
