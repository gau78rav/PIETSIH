...
<div class="header">
	<div class="heading1">
		<h1><i class="fa fa-key" style="margin-right: 10px;font-size: 35px"></i>Login Form for <b>Adocate</b></h1>
...
<i class="fa fa-key" style="margin-right: 10px;font-size: 35px"></i>Login As Advocate!!
</h3>
