...
<div class="header">
	<div class="heading1">
		<h1><i class="fa fa-key" style="margin-right: 10px;font-size: 35px"></i>Login Form for <b>Judge</b></h1>
...
<i class="fa fa-key" style="margin-right: 10px;font-size: 35px"></i>Login As Judge!!
</h3>
...
<tr >
    ...
    <td>
        <input type="text" name="license" id="loginid1" placeholder="Bar Council No..." autocomplete="off">
    </td>
</tr>

<tr>
	   <td >
            <center><i class="fa fa-envelope" style="font-size: 35px;"></i></center>
        </td>
        <td>
            <input type="text" name="captcha" id="captcha" placeholder="Mobile no./email" required="">
