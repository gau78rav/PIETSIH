...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2018 at 07:31 AM
...
CREATE TABLE IF NOT EXISTS `case_file_record` (
...
CREATE TABLE IF NOT EXISTS `court_list` (
  `c_id` int(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `file_petition` (
...
CREATE TABLE IF NOT EXISTS `judge_advocate` (
...
CREATE TABLE IF NOT EXISTS `next_date_time` (
...
CREATE TABLE IF NOT EXISTS `opponent_record` (
...
CREATE TABLE IF NOT EXISTS `reg_client` (
...
ALTER TABLE `case_file_record`
  ADD PRIMARY KEY (`id`), ADD KEY `case_no` (`case_no`), ADD KEY `court_id` (`court_id`), ADD KEY `client_id` (`client_id`), ADD KEY `advocate_id` (`advocate_id`);

--
-- Indexes for table `court_list`
--
ALTER TABLE `court_list`
  ADD PRIMARY KEY (`c_id`), ADD KEY `d_id` (`d_id`);

--
-- Indexes for table `district_list`
--
ALTER TABLE `district_list`
  ADD PRIMARY KEY (`d_id`), ADD KEY `s_id` (`s_id`);

--
-- Indexes for table `file_petition`
--
ALTER TABLE `file_petition`
  ADD PRIMARY KEY (`case_no`), ADD KEY `state_id` (`state_id`), ADD KEY `district_id` (`district_id`);

--
-- Indexes for table `judge_advocate`
--
ALTER TABLE `judge_advocate`
  ADD PRIMARY KEY (`bcn_id`), ADD KEY `state_id` (`state_id`), ADD KEY `district_id` (`district_id`), ADD KEY `court_id` (`court_id`);
...
ALTER TABLE `opponent_record`
  ADD PRIMARY KEY (`opponent_id`), ADD KEY `case_no` (`case_no`);
