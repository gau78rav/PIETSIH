...
<div class="main-content">
	<div class="list">
		<ul>
			<li style="background-color:#2B669B ;color: white"><i class="fa fa-dashboard" style="color: white"></i><br><a href="dashboard_content.php" target="output" style="color: white">Dashboard</a></li>
