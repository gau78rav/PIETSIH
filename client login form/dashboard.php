...
<div class="main-content">
	<div class="list">
		<ul>
			<li style="background-color:#4866af ;color: white"><i class="fa fa-dashboard" style="color: white"></i><br><a href="home.php" target="output" style="color: white">Status</a></li>
			<li><i class="fa fa-bell"></i><br><a href="">Notification</a></li>
			<li><i class="fa fa-user"></i><br><a href="profile_client.php" target="output">Profile</a></li>
